...
module8 - Not completed due to time constraints. However, the other modules reflect my understanding of the core concepts.
...
- use chmod +x (name of file).py and also ./(name of file).py (if it has shebang)
